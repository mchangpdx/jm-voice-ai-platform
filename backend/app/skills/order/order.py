    ...
    "function_declarations": [
        {
            ...
            "description": (
                ...
                "    the payment link AND has confirmed it AFTER you read it back. Speech-to-text "
                "    routinely garbles letters in spoken email — you MUST read the captured email "
                "    back to the customer ('Just to confirm, that's <local-part> at <domain> — "
                "    did I get that right?') and wait for explicit yes BEFORE calling this tool. "
                "    If they correct you, capture the new spelling and read THAT back too. While "
                "    SMS delivery is being verified, email is required — only omit customer_email "
                "    when the customer explicitly refuses email AND wants SMS only. "
