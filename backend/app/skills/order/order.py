    ...
    "function_declarations": [
        {
            ...
            "description": (
                ...
                "    last_order_total are non-empty) OR recent_orders just "
                "    returned recent_single (cross-call cancel path), "
                ...
                "    EXCEPTION: if (a) was satisfied via recent_orders "
                "    recent_single, the tool message ALREADY spoke the items "
                "    and total verbatim — a customer 'yes/cancel/please' on "
                "    the very next turn is the recital, do NOT add a second "
                "    'Just to confirm' line, "
